...
import { useCreateLawOffice } from "@/hooks/api/lawOffice/useCreateLawOffice";
...
export default function ContactForm() {
    ...
    const {
        ...
        defaultValues: {
            region: 1,
            isSupportingProgram: false,
            supportingProgram: "",
            isFreePlaces: false,
        },
    });

    const { mutate: createLawOffice, isPending } = useCreateLawOffice({
        onSuccess: () => {
            reset();
            toast({
                title: "Formulář odeslán ke schválení.",
                status: "success",
                duration: 5000,
                isClosable: true,
            });
    ...
    const handleData = async ({
        ...
        createLawOffice({
            ...
            secondEndTime,
            phone,
            isFreeCapacity: isSupportingProgram ? true : false,
